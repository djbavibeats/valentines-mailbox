    ...
    return (<>
        <div className="flex justify-between w-full items-center p-4 absolute z-40 bg-transparent bg-red-500">
            ...
            <div className="text-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#fbff8c" className="w-8 h-8 hover:cursor-pointer" onClick={ share }>
            ...
            {/* Menu Icon */}
            <div className="text-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#fbff8c" className="w-8 h-8 hover:cursor-pointer" onClick={ openWebsite }>
